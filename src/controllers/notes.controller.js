...
export const createNote = async (req, res) => {
  try {
    ...
    await publishToQueue(
      'notesQueue',
      JSON.stringify({ action: 'create', note })
    );
...
export const updateNote = async (req, res) => {
  try {
    ...
    await publishToQueue(
      'notesQueue',
      JSON.stringify({ action: 'update', note: updatedNote })
    );
    res.status(HttpStatus.OK).json({
      code: HttpStatus.OK,
      data: updatedNote,
...
export const deleteNote = async (req, res) => {
  try {
    ...
    await publishToQueue(
      'notesQueue',
      JSON.stringify({ action: 'delete', noteId: id })
    );
    res.status(HttpStatus.OK).json({
      code: HttpStatus.OK,
...
export const archiveNoteById = async (req, res) => {
  try {
    ...
    await publishToQueue(
      'notesQueue',
      JSON.stringify({ action: 'archive', note: updatedNote })
    );
    res.status(HttpStatus.OK).json({
      code: HttpStatus.OK,
      data: updatedNote,
...
export const trashNoteById = async (req, res) => {
  try {
    ...
    await publishToQueue(
      'notesQueue',
      JSON.stringify({ action: 'trash', note: updatedNote })
    );
    res.status(HttpStatus.OK).json({
      code: HttpStatus.OK,
      data: updatedNote,
...
export const unarchiveNoteById = async (req, res) => {
  try {
    ...
    await publishToQueue(
      'notesQueue',
      JSON.stringify({ action: 'unarchive', note: updatedNote })
    );
    res.status(HttpStatus.OK).json({
      code: HttpStatus.OK,
      data: updatedNote,
...
export const untrashNoteById = async (req, res) => {
  try {
    ...
    await publishToQueue(
      'notesQueue',
      JSON.stringify({ action: 'untrash', note: updatedNote })
    );
    res.status(HttpStatus.OK).json({
      code: HttpStatus.OK,
      data: updatedNote,
